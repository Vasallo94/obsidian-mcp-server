...
### Fixed
- **Vault exclusion hygiene**: `.trash` is now part of the shared packaged boundary, and the unused `.mcpignore` implementation and dependency were removed so the documented security model has one source of truth.
